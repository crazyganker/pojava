...
/**
 * This tool runs an external program through your OS, and stuffs the results
 * from stdout and stderr into their own StringBuffers.
 * 
 * @author John Pile
 * 
 */
public class ProcessTool {
	...
	/**
	 * This method runs an executable, capturing its output from stdout and stderr
	 * into StringBuffers.
	 * 
	 ...
	 * @throws InterruptedException
	 */
	public static int exec(String command, StringBuffer stdout,
