...
public class FieldMap {
     ...
     * @param tableMap
     */
    public FieldMap(String property, String fieldName, boolean isKeyField, Class columnClass,
            TableMap tableMap) throws NoSuchMethodException {
        ...
        this.adaptor = DefaultAdaptorMap.getInstance().chooseAdaptor(parentType, this.getters,
                columnClass);
    }
     ...
     */
    public FieldMap(String property, String fieldName, boolean isKeyField, TableMap tableMap,
            Class columnClass, AdaptorMap adaptorMap) throws NoSuchMethodException {
        Class parentType = tableMap.getJavaClass();
        this.property = property;
        this.columnName = fieldName;
        this.keyField = isKeyField;
        ...
        this.tableMap = tableMap;
        this.columnClass = columnClass;
        this.adaptor = adaptorMap.chooseAdaptor(parentType, this.getters, columnClass);
    }
    ...
    public FieldMap(String property, String fieldName, boolean isKeyField,
            TypedAdaptor adaptor, TableMap tableMap) throws NoSuchMethodException {
        Class parentType = tableMap.getJavaClass();
        this.property = property;
        this.columnName = fieldName;
        this.keyField = isKeyField;
