...
public class BoundString {
	...
	/**
	 * Display an unbound equivalent of this BoundString with String versions of
	 * each bound value represented in-line in place of the markers.
	 * 
	 * @return String with toString versions of bound values inserted back into
	 *         the String.
	 */
			...
			if (c == '?') {
				...
				if (binding.getObj() == null) {
					...
					if (type == Integer.class || type == int.class
						...
						sb.append(formatDate(new DateTime(((Date) obj)
								.getTime())));
					} else {
						sb.append(quot);
