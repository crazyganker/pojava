 ...
 * very basic query could look like the following: <code>
 ...
 *   }
 * }
 * </code> If you created your own custom provider, say, for an XML query using xpath, your
 * class may look like this (note that your business layer still defines the number of legs the
 * same way for either implementation): <code>
