...
public class TypeTestDao {
	...
	public static int insert(ConnectionSource connector, TypeTest obj)
			throws SQLException {
		return DaoTool.insert(connector.getConnection(DS_NAME), MAP, obj);
	}

	public static int update(ConnectionSource connector, TypeTest obj)
			throws SQLException {
	...
	public static int delete(ConnectionSource connector, TypeTest obj)
			throws SQLException {
		return DaoTool.delete(connector.getConnection(DS_NAME), MAP, obj);
	}

	public static TypeTest find(ConnectionSource connector, TypeTest obj)
			throws SQLException {
