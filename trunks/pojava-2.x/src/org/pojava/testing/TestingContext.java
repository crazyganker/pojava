 ...
 * one provided by server.xml, it should work exactly as expected.
 * 
 * This is not a full implementation of a Context and will break down for
 * certain operations involving subcontexts. Most notably, a subcontext returned
 * by a lookup(...) will yield a snapshot view that is only partially
 * synchronized with its parent context. It supports only a one-way relationship
 * where changes to the subcontext are visible to the parent, but not the other
 * way around.
 * 
 * 
 * @author jpile
...
public class TestingContext implements Context {
	...
	/**
	 * The syntax "java:/path" and "java:path" are both in popular use. This
	 * method normalizes both to "java/path".
	 * 
	 * @param name
	 * @return
	 */
	...
	/**
	 * Register an object under a specific name. This synchronizes a parent from
	 * any child, but not the other way around. Good enough for our purposes...
	...
	public Context createSubcontext(Name name) throws NamingException {
		throw new UnsupportedOperationException(
				"createSubcontext(Name name) Not implemented.");
	}
	...
	public void destroySubcontext(Name name) throws NamingException {
		throw new UnsupportedOperationException(
				"destroySubcontext(Name name) Not implemented.");
	}
	...
	public String getNameInNamespace() throws NamingException {
		throw new UnsupportedOperationException(
				"getNameInNamespace() Not implemented.");
	}

	public NameParser getNameParser(Name name) throws NamingException {
		throw new UnsupportedOperationException(
				"getNameParser(Name name) Not implemented.");
	}
	...
	/**
	 * Retrieve an object registered under a specific name. This shortcuts some
	 * of the work necessary to support more complex and mature implementations
	 * by returning only a snapshot of the requested subcontext.
	 * 
	 * It's likely good enough to do everything we need for unit testing, but
	 * not good enough to serve as a production implementation of a Context.
	 */
	...
	public Object lookupLink(Name name) throws NamingException {
		throw new UnsupportedOperationException(
				"lookupLink(Name name) Not implemented.");
	}

	public Object lookupLink(String name) throws NamingException {
		throw new UnsupportedOperationException(
				"lookupLink(String name) Not implemented.");
	}
	 ...
	 * Good enough for our purposes... just be aware of the limitation.
	 */
