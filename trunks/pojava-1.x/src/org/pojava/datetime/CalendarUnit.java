...
public class CalendarUnit extends Ordinal {
     ...
     */
    public static final CalendarUnit MICROSECOND = new CalendarUnit("MICROSECOND");
    /**
     * A MILLISECOND = a thousandth of a second
     */
    public static final CalendarUnit MILLISECOND = new CalendarUnit("MILLISECOND");
    /**
    ...
    /**
     * An HOUR = a shift of one hour on the clock, regardless of elapsed time. For example,
     * adding 3 CalendarUnit.HOUR units to a DateTime value at midnight will always evaluate to
     * 3:00am, regardless of whether Daylight Saving Time begins or ends on that date.
     */
