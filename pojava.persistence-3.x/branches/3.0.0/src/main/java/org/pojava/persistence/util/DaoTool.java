...
public class DaoTool {
     ...
     *
     * @param map Map of table fields
     * @param query SQL Query
     * @param action action
     */
    private static <T> void validateParamsQuery(TableMap<T> map, SqlQuery query,
                                                      String action) {
        if (query == null) {
     ...
     * @param map  TableMap describing bean to table mappings
     * @param list List of objects of the class specified in map
